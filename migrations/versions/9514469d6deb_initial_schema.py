...
def upgrade():
    ...
    sa.Column('color', sa.Enum('BEIGE', 'WHITE', 'BURGUNDY', 'SMOKE', 'GRAY', 'SILVER_GRAY', 'BROWN', 'RED', 'NAVY_BLUE', 'BLUE', 'PURPLE', 'PINK', 'YELLOW', 'BLACK', 'CHAMPAGNE', 'TURQUOISE', 'ORANGE', 'GREEN', name='color'), nullable=True),
    sa.Column('model_year', sa.Integer(), nullable=True),
    sa.Column('transmission_type', sa.Enum('MANUAL', 'AUTOMATIC', 'SEMI_AUTOMATIC', name='transmissiontype'), nullable=True),
    sa.Column('fuel_type', sa.Enum('GASOLINE', 'LPG', 'DIESEL', 'ELECTRIC', 'HYBRID', name='fueltype'), nullable=True),
